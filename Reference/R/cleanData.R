...
# -------------------------------------------------------------------------------------------------------------------------
demoData <- read.csv('E:/NYU/1/Foundation of Data Science/Projects/Master/DEMOGRAPHICS.csv')
...
# -------------------------------------------------------------------------------------------------------------------------
leadCauseData <- read.csv('E:/NYU/1/Foundation of Data Science/Projects/Master/LEADINGCAUSESOFDEATH.csv')
...
# -------------------------------------------------------------------------------------------------------------------------
# Load risk data and clean
riskData <- read.csv('E:/NYU/1/Foundation of Data Science/Projects/Master/RISKFACTORSANDACCESSTOCARE.csv')
summary(riskData)
